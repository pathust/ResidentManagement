...
export async function GET(req, { params }) {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            return NextResponse.json({ error: errorData.detail || "Failed to fetch" }, { status: response.status });
        }
...
// Handle PUT requests to fetch persons data
...
// Handle DELETE requests to fetch persons data
export async function DELETE(req, { params }) {
    ...
    try {
        ...
        if (!response.ok) {
            const errorData = await response.json();
            return NextResponse.json({ error: errorData.detail || "Failed to delete" }, { status: response.status });
        }
