...
-- ------------------------------------------------------------
-- 2. BỔ SUNG QUẬN / HUYỆN / PHƯỜNG / XÃ
-- ------------------------------------------------------------
...
-- =================================================================
-- II. DỮ LIỆU NGƯỜI DÙNG HỆ THỐNG & PHÂN QUYỀN
-- =================================================================
...
VALUES
    (1, 1), (1, 2), (1, 3), (1, 4), (1, 5), -- ADMIN: Toàn quyền
    (2, 1), (2, 2), (2, 3),               -- MANAGER: Quản lý dân cư, xem báo cáo
    (3, 1), (3, 4),                       -- COLLECTOR: Thu phí
    (4, 1);                               -- RESIDENT: Xem thông tin cá nhân

-- Tạo tài khoản mẫu (Password hash là 'password123' hoặc tương tự)
...
VALUES
    ...
    ('quanly', '$2a$12$K4ZCq0.Qy1bsxLzvp7ELQuVlkaMGvUau7xz5/xZG5CeZg9bpnTxDS', 2, NULL, NOW(), NOW()), -- Manager
    ('thuphi', '$2a$12$mwoieiJRIVNg7oUjpfI2XeIes8UVFtc9CSxv9LBvkYMc0KVfMBy3u', 3, NULL, NOW(), NOW()), -- Collector
    ('cudan', '$2a$12$Q6l6iky1PKKSwWIiXJwvtOXv9JE3MsJsBVSQP5augHTaq57ptBcwG', 4, 1, NOW(), NOW());   -- Resident

-- =================================================================
-- III. DỮ LIỆU CƯ DÂN & HỘ KHẨU
-- =================================================================

-- Tạo hộ khẩu (Địa chỉ tại Phường Bến Nghé, Q1 - ward_id = 1 và Hà Nội - ward_id = 3)
...
-- Tạo thông tin nhân khẩu (Thông tin thuần Việt)
...
VALUES
    -- Người 1: Chủ hộ HK001
    (1, 'Nguyễn Văn An', '1980-05-15', 'Hà Nội', 3, 'Kim Mã, Ba Đình', 1, 'Không', 'M', 'Kỹ sư xây dựng', 'Vinaconex', '001080001234', '2021-01-01', 'Cục CS QLHC về TTXH', '0912345678', 'nguyenvanan@gmail.com', 'ALIVE', 'Chủ hộ HK001', 1, NOW(), NOW()),

    -- Người 2: Vợ chủ hộ HK001
    (1, 'Trần Thị Bích', '1985-08-20', 'Nam Định', 1, 'TP Nam Định', 1, 'Phật giáo', 'F', 'Giáo viên', 'Trường THPT Trưng Vương', '001185005678', '2021-02-02', 'Cục CS QLHC về TTXH', '0987654321', 'tranthibich@gmail.com', 'ALIVE', 'Vợ ông An', 1, NOW(), NOW()),

    -- Người 3: Con trai chủ hộ HK001
    (1, 'Nguyễn Văn Cường', '2012-03-10', 'TP Hồ Chí Minh', 1, NULL, 1, 'Không', 'M', 'Học sinh', 'Trường THCS Đồng Khởi', NULL, NULL, NULL, NULL, NULL, 'ALIVE', 'Con ông An', 1, NOW(), NOW());

-- Quan hệ nhân thân (Sổ hộ khẩu)
...
-- =================================================================
-- IV. DỮ LIỆU QUỸ & THU PHÍ (TÀI CHÍNH)
-- =================================================================

-- Các loại phí thường gặp ở chung cư/tổ dân phố
...
-- Giao dịch nạp tiền ban đầu vào quỹ
...
VALUES
    ...
    (2, 'INFLOW', 5000000.00, '2025-10-01', NULL, 'INITIAL', 1, 'Tài trợ từ Ban quản trị cho Quỹ khuyến học', NOW());

-- Tạo đợt thu phí tháng 10/2025
...
VALUES
    (1, '2025-10-01', '2025-10-15', 'Thu phí quản lý tháng 10/2025', 3, 2, 500000.00, 'OPEN', 1, NOW(), NOW());

-- Hộ gia đình ông An đóng tiền
...
VALUES
    (1, 1, 1, 500000.00, 500000.00, '2025-10-05', 'TRANSFER', 'COMPLETED', 'Chuyển khoản VCB - Noi dung: P15 Le Thanh Ton dong phi T10', 1, NOW(), NOW());

INSERT INTO payment_logs (payment_id, change_type, change_date, amount, details, user_id)
VALUES
    (1, 'CREATE', NOW(), 500000.00, 'Ghi nhận thanh toán qua chuyển khoản', 3);

-- Chi tiêu từ quỹ (Mua văn phòng phẩm)
...
VALUES
    (1, '2025-10-06', 300000.00, 'Mua giấy in và mực in cho văn phòng BQL', 2, 'Nhà sách Fahasa', 'hoadon_fahasa_001.jpg', 'APPROVED', 'Đã duyệt chi', NOW(), NOW());

-- =================================================================
-- V. DỮ LIỆU KHEN THƯỞNG & SỰ KIỆN
-- =================================================================

INSERT INTO reward_types (name, description, default_amount, created_at, updated_at)
VALUES
    ('Học sinh Giỏi cấp Quận/Huyện', 'Thưởng cho học sinh đạt giải hoặc danh hiệu HSG', 200000.00, NOW(), NOW());

INSERT INTO reward_events (name, event_date, fund_id, approver_user_id, status, created_at, updated_at)
VALUES
    ('Tuyên dương học sinh giỏi năm học 2024-2025', '2025-10-15', 2, 2, 'COMPLETED', NOW(), NOW());

-- Trao thưởng cho cháu Cường
...
VALUES
    (1, 3, 1, 200000.00, 'Phong bì 200k và 10 quyển vở Campus', 'PAID', '2025-10-16', NOW(), NOW());

-- =================================================================
-- VI. CÁC NGHIỆP VỤ BỔ SUNG (CHUYỂN QUỸ, TIỀN NƯỚC)
-- =================================================================

-- 1. Chuyển 500k từ Quỹ chung sang Quỹ khen thưởng để bù chi
INSERT INTO fund_transfers (source_fund_id, dest_fund_id, amount, transfer_date, reason, user_id, status, created_at, updated_at)
VALUES (1, 2, 500000.00, '2025-10-20', 'Trích quỹ chung hỗ trợ sự kiện khen thưởng', 2, 'COMPLETED', NOW(), NOW());

-- Giao dịch hệ thống cho việc chuyển tiền
INSERT INTO fund_transactions (fund_id, transaction_type, amount, transaction_date, reference_id, reference_type, user_id, notes, created_at)
VALUES
    (1, 'TRANSFER_OUT', 500000.00, '2025-10-20', 1, 'TRANSFER', 2, 'Chuyển sang Quỹ Khuyến học', NOW()),
    (2, 'TRANSFER_IN', 500000.00, '2025-10-20', 1, 'TRANSFER', 2, 'Nhận từ Quỹ Hoạt động chung', NOW());

-- 2. Tạo đợt thu tiền nước (id=2)
INSERT INTO collection_events (fee_type_id, event_date, due_date, description, collector_user_id, approver_user_id, total_expected, status, fund_id, created_at, updated_at)
VALUES
    (2, '2025-10-01', '2025-10-20', 'Tiền nước tháng 10/2025', 3, 2, 150000.00, 'OPEN', 1, NOW(), NOW());

-- 3. Hộ gia đình HK002 (Bà Lan) đóng tiền nước
INSERT INTO payments (collection_event_id, household_id, person_id, expected_amount, amount_paid, payment_date, method, status, notes, fund_id, created_at, updated_at)
VALUES
    (2, 2, NULL, 150000.00, 150000.00, '2025-10-18', 'CASH', 'COMPLETED', 'Đóng tiền mặt tại văn phòng', 1, NOW(), NOW());

INSERT INTO payment_logs (payment_id, change_type, change_date, amount, details, user_id)
VALUES
    (2, 'CREATE', NOW(), 150000.00, 'Thu ngân nhận tiền mặt', 3);